...
2. 展開 `進階`，接著點擊繼續前往指定的網址。

   ![](images/img_18.png)

<br>

3. 帳號為 `openvpn`，密碼就是前面步驟自訂的密碼，然後點擊 `Sign in`。
...
5. 左側切換到 `VPN Settings`。

   ![](images/img_21.png)

<br>

6. 在 `Routing` 區塊將第一個按鈕切換到 `Yes`。

   ![](images/img_22.png)

<br>

7. 滑動到最下方點擊 `Save Settings`。

   ![](images/img_23.png)

<br>

8. 接著點擊最上方的 `Update Running Server`。
