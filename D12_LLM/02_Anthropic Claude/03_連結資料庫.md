...
# 從 .env 取得設定值
pg_user = os.environ.get('POSTGRES_USER', 'sam')
pg_db = os.environ.get('POSTGRES_DB', 'testdb')
pg_pass = os.environ.get('POSTGRES_PASSWORD', '112233')
...
_可延伸到 Flask、Streamlit 或網頁 API 查詢模式_
